...
class GameSlotVC: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
        ...
        didSet {
            if visibleCount == 7 {
                ...
                saveHistory(player: "Your Total Visible Item are \(self.visibleCount) in without time game")
                    ...
                    showAlert(title: "You Won", message: "You clear All the Round Won the game")
    ...
    override func viewDidLoad() {
        ...
        roll()
        setupImageViews()
        showAlert(title: "Info", message: "Spin the wheel and get three items . if spin image is more than 1 than that image visible user has to comple the whole rounds of games and win the game in the 20 chances ")
